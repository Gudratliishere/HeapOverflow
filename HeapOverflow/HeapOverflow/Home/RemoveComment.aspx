<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoveComment.aspx.cs" Inherits="HeapOverflow.Home.RemoveComment" %>
...
<body>
	<form id="remove_comment" runat="server">
		<header>
			<div class="navbar">
		...
		<div class="container">
			<center>
				<div class="login-body">
					<div class="login-label">Are you sure to remove Comment? </div>
